...
TEST_BASENAMES = [ 'prot-198687--11', 'prot-200405--7', 'prot-1961--fk--6', 'prot-1961--ak--5', 'prot-1936--ak--8', ]
...
def test_expand_target_files():
    ...
    target_files: list[str] = expand_target_files(source_folder=source_folder, source_extension=source_extension, target_folder=target_folder, target_extension=target_extension, years=None)
